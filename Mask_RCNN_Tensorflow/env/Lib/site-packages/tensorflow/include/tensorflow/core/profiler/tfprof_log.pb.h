...
class CodeDef_Trace :
 ...
 public:
  ...
  PROTOBUF_DEPRECATED static const int kFileFieldNumber = 1;
  ...
  PROTOBUF_DEPRECATED static const int kFunctionFieldNumber = 3;
  ...
  PROTOBUF_DEPRECATED static const int kLineFieldNumber = 4;
